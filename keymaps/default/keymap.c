...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
      ...
      _______, KC_LALT, MO(2),                     KC_SPACE,                 KC_RGUI, KC_RALT, _______
      ),
  ...
  [2] = LAYOUT(
      ...
      _______, _______, _______, _______, _______, _______, KC_PGDN, _______, _______, _______, _______, _______, MO(3),
